...
- **AI Enablement / AI Adoption** -- Head / Manager / Director / Lead of AI Enablement, AI Adoption, AI Transformation, or AI Training / Upskilling / Literacy / Fluency. Internal, employee-facing charters (enabling a company's own workforce on AI) are just as in-scope as customer-facing ones -- treat them as a primary target, not an adjacency. These charters also appear under individual-contributor and program titles beyond the Head/Manager/Director/Lead bands -- e.g. "AI Enablement Specialist," "AI Enablement Engineer," "AI Enablement Program Manager" -- which are in scope on the same footing. The developer-facing exclusion below still governs by *audience*, not by the word "Engineer": an "enablement engineer" title whose audience is a company's own workforce or its customers is in; one whose audience is developers / software engineers is out.
...
- Curriculum or content production as the entire job -- authoring courses, staffing an "academy" / "university," or classroom-style instruction with no direct, ongoing customer engagement and no ownership of adoption / retention outcomes. Nicky's target is hands-on enablement "in the trenches" with customers -- direct coaching and advising that drives adoption and retention -- not producing training material for customers to consume on their own at a remove. The tell for content-at-a-remove is a deliverable framed around *scaled self-service* rather than direct engagement: building a "self-service learning ecosystem," selecting or administering an LMS, standing up certification / academy programs, or "scalable learning experiences" whose stated goal is customer *self-sufficiency*. A role that is teaching / curriculum-authoring end to end, however senior, is a weak fit -- discernible from whether the JD describes working *with customers* or only *producing materials for* them
...
- Partner / channel GTM titles: Partner Enablement, Channel Enablement, Partner Programs, Partner Integrations, Partner / Channel Marketing, Partnerships -- or any title whose primary charter is recruiting, enabling, or managing reseller / VAR / MSP / SI / channel partners. Repeated ground-truth review decides these Skip every time: they are partnerships / GTM roles, not customer enablement, even when they carry "enablement" in the title. (This targets the channel-partner charter specifically. A title that merely contains the word "partner" in an unrelated sense -- e.g. an AI-adoption role that acts as a "partner" to internal teams or end customers -- is not excluded by this rule; read the charter, not the substring.)
